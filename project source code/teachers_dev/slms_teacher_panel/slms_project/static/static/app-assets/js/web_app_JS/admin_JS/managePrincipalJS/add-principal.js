...
function add_new_principal(){
    ...
    if(principal_name_flag == true || city_flag == true || principal_dob_flag == true || principal_gender_flag == true || principal_fathers_name_flag == true || principal_email_flag == true || principal_contact_flag == true || pincode_flag == true || branchCode_flag == true || image_flag == true){
        return false;
    }else{
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(response['message'] == 'success'){
                    Swal.fire({
                        icon: 'success',
                        title: 'New principal added successfully.',
                        showConfirmButton: false,
                        timer: 2000
                    }).then(function () {
                        window.location.href = 'principal-list'
                    })
                }else{
                    alert('An Error occured while adding new principal. Please try again!');
                    return false;
                }
            }
        });
