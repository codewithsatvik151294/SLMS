<?php  $txt="Masters" ; $subP="class-list"; include('../header-1.php');  ?>
      ...
      <div class="content-wrapper">
        <div class="content-body "> 
          <div class="top-options">
            <div class="row">
              <div class="col-md-3"><h3 >Upload Class List </h3></div>
                 <div class="col-md-9 text-right ">
                    <a href="class-list.php" class="btn  btn-default  btn-sm"><i class="fa fa-arrow-left"></i>   Back to List</a>
                 </div>
           </div>
           </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
           ...
           <p>Class list has been uploaded successsfully.  </p>
