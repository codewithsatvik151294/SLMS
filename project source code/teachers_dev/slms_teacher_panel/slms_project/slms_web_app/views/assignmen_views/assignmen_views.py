...
# from slms_web_app.views.auth_views import teacher_login, Teacher_profile
...
from ...models.manage_models import class_master,branch,Teacher_profile,schoolAdmin_profile,Teacher_profile
