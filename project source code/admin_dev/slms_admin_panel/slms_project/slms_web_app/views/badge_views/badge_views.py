...
import datetime
from ...models.manage_models import branch,schoolAdmin_profile,director_profile,principal_profile
import datetime
# #####################################################################################################################
# badge_list view
# #####################################################################################################################
                ...
                if(sub_auth_dict['Edit_Badge'] == True):
                    ...
                    try:
                        ...
                        try:
                            ...
                            if image != None:
                                badge_triggetObj.badge_image = image
                            badge_triggetObj.last_updated_by = f"School Admin - {directorObj.schoolAdmin_FK.schoolAdmin_name}"
                            badge_triggetObj.last_updated_at = datetime.datetime.now()
                            badge_triggetObj.save()
                            return JsonResponse({'message':message})
                        except:
