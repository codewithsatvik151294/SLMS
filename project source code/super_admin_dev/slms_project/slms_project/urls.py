...
urlpatterns = [
    ...
    path('approval-management/',include('slms_web_app.urls.approval_URLs')),
    path('time-table-management/',include('slms_web_app.urls.time_table_URLs')),
    path('attendance-management/',include('slms_web_app.urls.attendance_URLs')),
