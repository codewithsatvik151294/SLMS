    ...
    if request.method == 'GET':
        ...
        if 'userType' in request.session:
            if(request.session['userType'] == 'super_admin_login'):
                ...
                student_profile_obj = student_profile.objects.all().order_by('-id')
                return render(request,'admin_template/manage-type/student/student-list.html',{'branchObj':branchObj,'student_profile_obj':student_profile_obj})
...
def add_new_student(request):
    if request.method == 'GET':
        ...
        if 'userType' in request.session:
            if(request.session['userType'] == 'super_admin_login'):
                branchObj = branch.objects.all().order_by('-id')
                return render(request,'admin_template/manage-type/student/add-student.html',{'branchObj':branchObj,'auth_dict':auth_dict,'sub_auth_dict':sub_auth_dict})
        ...
        if 'userType' in request.session:
            if(request.session['userType'] == 'super_admin_login'):
                ...
                try:
                    ...
                    student_user_obj.last_updated_by = "Super Admin"
                    ...
                    student_profile_obj.last_updated_by = "Super Admin"
                    student_profile_obj.save()
                    ...
                    parent_user_obj.last_updated_by = "Super Admin"
                    student_profile_obj.save()
