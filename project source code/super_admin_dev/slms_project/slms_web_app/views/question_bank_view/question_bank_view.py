    ...
    if request.method == 'GET':
        ...
        if 'userType' in request.session:
            if(request.session['userType'] == 'super_admin_login'):
                questionObj = question.objects.all().order_by('-id')
                classObj = class_master.objects.all()
                yearObj = year_master.objects.all()
                questionTypeObj = question_type_master.objects.all()
                return render(request,'admin_template/question-bank/question-list.html',{'classObj':classObj,'yearObj':yearObj,'questionTypeObj':questionTypeObj,'questionObj':questionObj})
    ...
    if request.method == 'GET':
        ...
        if 'userType' in request.session:
            if(request.session['userType'] == 'super_admin_login'):
                ...
                yearObj = year_master.objects.all()
                questionTypeObj = question_type_master.objects.all()
                return render(request,'admin_template/question-bank/add-questions.html',{'branchObj':branchObj,'classObj':classObj,'yearObj':yearObj,'questionTypeObj':questionTypeObj,'questionObj':questionObj})
